...
class Archive extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('category_id, title, content, status, tags, created_at, updated_at', 'required'),
			...
			array('id, category_id, title, content, status, tags, created_at, updated_at', 'safe', 'on'=>'search'),
		);
	}
